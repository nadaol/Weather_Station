...
# Obtengo la libreria comun con C

libPyC = CDLL("./libpyc.so")

#tempI = 1
#print 'INIT tempI: ', tempI
    ...
    if(thSensorOn):
      try:  
        ...
        if tempFormat == 'F':
          ...
          tempCel = float(temperatureString)
          tempF = libPyC.fahrenheit(c_float(tempCel))
          temperatureString = str(float(tempF))
      except:
        temperatureString = 'ERROR'
        humidityString = 'ERROR'    
